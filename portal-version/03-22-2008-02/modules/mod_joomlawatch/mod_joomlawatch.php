...
$redirURI = @ $_SERVER[JOOMLAWATCH_SERVER_URI_KEY];
...
$joomlaWatch->insertVisit();

$joomlaWatchHTML = new JoomlaWatchHTML();
/* 
 * Following piece of code identifies the userAgent and inserts the backlink to codegravity.com
 * 
 * I would really appreciate you'll keep the link there. 
 *
 * It took me some time to create this component and share it with everyone. 
 *
...
<img src='" . $joomlaWatchHTML->mosConfig_live_site . "/components/com_joomlawatch/img.php?rand=" . (rand() % 100000) . "' border='0' alt='JoomlaWatch Stats " . JOOMLAWATCH_VERSION . " by Matej Koval' title='JoomlaWatch Stats " . JOOMLAWATCH_VERSION . "'/></a>");
?>
