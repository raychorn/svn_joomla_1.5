...
// Read params
$image_rel_path = $params->get( 'image_path', 'images/stories/');

$exp_url = parse_url($mosConfig_live_site);
$url = @$exp_url["path"] . '/' . $image_rel_path;
...
*/
$IMConfig['base_dir'] = $mosConfig_absolute_path . '/' . $image_rel_path;
...
$IMConfig['maxHeight'][0] = 600;
$IMConfig['maxWidth'][1] = 400;
$IMConfig['maxHeight'][1] = 300;
$IMConfig['maxWidth'][2] = 225;
$IMConfig['maxHeight'][2] = 169;
