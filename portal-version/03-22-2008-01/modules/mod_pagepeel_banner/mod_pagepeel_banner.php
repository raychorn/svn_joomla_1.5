...
if ($numrows){
	...
	if ($numrows > 0) {
		...
		} else if (eregi( "(\.bmp|\.gif|\.jpg|\.jpeg|\.png\.swf$)$", $banner->imageurl )) {
	...
	$imageurl 	= 'modules/pagepeel_banner/'."$alterimage".'';
	$link		= $alterlink;
}
?>
...
//  URL to small image 
var pagearSmallImg = 'modules/pagepeel_banner/<?php echo $peelsmallimage; ?>'; 
