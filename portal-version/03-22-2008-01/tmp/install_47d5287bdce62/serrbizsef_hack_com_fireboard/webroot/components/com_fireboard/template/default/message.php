<?php
/**
* @version $Id: message.php 63 2007-04-17 21:23:17Z danialt $
* Fireboard Component
* @package Fireboard
...
<table width = "100%" border = "0" cellspacing = "0" cellpadding = "0">
    <caption>
        <a name = "<?php echo $msg_id;?>" id = "<?php echo $msg_id;?>"/>
    </caption>

    <tbody>
        <tr class = "fb_sth">
            <th colspan = "2" class = "view-th <?php echo $boardclass; ?>sectiontableheader">
               <a href="<?php echo sefRelToAbs("index.php?".$_SERVER["QUERY_STRING"])?>#<?php echo $msg_id; ?>">#<?php echo $msg_id; ?></a>
            </th>
        </tr>
        ...
        <tr>
            ...
            <td class = "fb-msgview-right">
                <table width = "100%" border = "0" cellspacing = "0" cellpadding = "0">
                    <tr>
                        <td align = "left">
                            <span class = "msgtitle"><?php echo $msg_subject; ?> </span> <span class = "msgdate" title="<?php echo $msg_date?>"><?php echo time_since($fmessage->time , time() + ($fbConfig['board_ofset'] * 3600)); ?> ago</span>
                        </td>
                        ...
                        <td align = "right">
                            ...
                            <?php
                            if ($msg_karma) {
                                echo $msg_karma . '&nbsp&nbsp' . $msg_karmaplus . ' ' . $msg_karmaminus;
                            }
                            else {
                                echo '&nbsp;';
                            }
                    ...
                    <tr>
                        <td colspan = "2" valign = "top">
                            ...
                            <form action = "<?php echo JB_LIVEURLREL. '&amp;func=post'; ?>" method = "post" name = "postform" enctype = "multipart/form-data">
								...
								<img src="<?php echo JB_DIRECTURL ;?>/template/default/plugin/captcha/randomImage.php"><br />
								<?php
								}
								// Finish captcha 
								?>
  ...
  <tr>
            ...
            <td class = "fb-msgview-right-c" >  
                   ...
                   <?php 
                            ...
                            $link = sefRelToAbs('index.php?option=com_fireboard&amp;func=report&amp;Itemid='.FB_FB_ITEMID.'&amp;msg_id='.$msg_id);
                            ?>                                
...
?>
        ...
        <tr>
            ...
            <td class = "fb-msgview-right-b" align = "right">
                ...
                <?php echo
                    $fbIcons['quickmsg']
                        ? '<img src="' . JB_URLICONSPATH . '' . $fbIcons['quickmsg'] . '" border="0" alt="' . _FB_QUICKMSG . '" />' . '' : '  <img src="' . JB_URLEMOTIONSPATH . 'quickmsg.gif" border="0"   alt="' . _FB_QUICKMSG . '" />'; ?></span>
