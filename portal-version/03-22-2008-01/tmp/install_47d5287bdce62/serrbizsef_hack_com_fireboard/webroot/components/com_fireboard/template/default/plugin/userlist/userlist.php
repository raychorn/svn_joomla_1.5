<?php
/**
* @version $Id: userlist.php 296 2007-08-18 07:51:06Z greatpixels $
* Fireboard Component
* @package Fireboard
...
function convertDate($date)
{
    ...
    if ($date != "0000-00-00 00:00:00" && ereg("([0-9]{4})-([0-9]{2})-([0-9]{2})[ ]([0-9]{2}):([0-9]{2}):([0-9]{2})", $date, $regs))
    {
        ...
        $date = $date > -1 ? strftime($format, $date + ($mosConfig_offset * 60 * 60)) : '-';
    }
    else {
        $date = _FB_USRL_NEVER;
    }
                    ...
                    <th>
                        <table width = "100%" border = "0" cellspacing = "0" cellpadding = "0">
                            <tr>
                                ...
                                <td align = "right">
                                    <form name = "usrlform" method = "post" action = "<?php echo "$base_url"; ?>" onSubmit = "return validate()">
                                        <input type = "text"
                                            name = "search"
                                            class = "inputbox"
                                            style = "width:150px"
    ...
    <img src = <?php echo JB_TMPLTMAINIMGURL ."/images/up.gif" ;?> border = "0" alt = "<?php echo _FB_USRL_DESC; ?>"/></a>
                            ...
                            foreach ($ulrows as $ulrow)
                            {
                                ...
                                if ($fbConfig['avatar_src'] == "clexuspm") {
                                    $uslavatar = '<img  border="0" class="usl_avatar" src="' . MyPMSTools::getAvatarLinkWithID($ulrow->id, "s") . '" />';
                                }
                                else if ($fbConfig['avatar_src'] == "cb")
                                {
                                    ...
                                    if ($avatar != '')
                                    {
                                        ...
                                        $uslavatar = '<img  border="0" class="usl_avatar" src="' . $imgpath . '" />';
                                    }
                                }
                                else
                                {
									...
									if(!file_exists(FB_ABSUPLOADEDPATH . '/avatars/s_' . $avatar)) {
										$uslavatar = '<img  border="0" class="usl_avatar" src="' . FB_LIVEUPLOADEDPATH . '/avatars/' . $avatar . '" />';
										}else {
                                        $uslavatar = '<img  border="0" class="usl_avatar" src="' . FB_LIVEUPLOADEDPATH . '/avatars/s_' . $avatar . '" />';
										}
                                    }
                                    else {$uslavatar = '<img  border="0" class="usl_avatar" src="' . FB_LIVEUPLOADEDPATH . '/avatars/s_nophoto.jpg" />'; }
                                }
                                //
                            ?>
