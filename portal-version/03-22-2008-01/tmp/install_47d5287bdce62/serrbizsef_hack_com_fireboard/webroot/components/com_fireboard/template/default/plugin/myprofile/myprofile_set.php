<?php
/**
* @version $Id: myprofile_set.php 239 2007-07-31 21:48:18Z greatpixels $
* Fireboard Component
* @package Fireboard
...
<form action = "<?php echo JB_LIVEURLREL.'&amp;func=myprofile&amp;do=updateset'; ?>" method = "POST" name = "postform">
	...
	<table class = "fb_blocktable" id = "fb_forumprofile_sub" border = "0" cellspacing = "0" cellpadding = "0" width="100%">
		...
		<tbody class = "fb_myprofile_general">
            ...
            <tr >
				<td >
					<strong><?php echo _USER_SHOWEMAIL; ?>*</strong>:
				</td>
