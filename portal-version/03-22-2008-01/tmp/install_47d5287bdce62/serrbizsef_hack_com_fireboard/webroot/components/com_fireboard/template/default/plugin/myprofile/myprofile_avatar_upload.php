<?php
/**
* @version $Id: avatar_upload.php 63 2007-04-17 21:23:17Z danialt $
* Fireboard Component
* @package Fireboard
...
<div class="<?php echo $boardclass; ?>_bt_cvr5">
            <form action = "<?php echo JB_LIVEURLREL.'&amp;func=myprofile&amp;do=updateavatar'; ?>" method = "POST" name = "postform">
            ...
            <tr>
                <td >
                    ...
                    ?>
                                ...
                                <img src = "<?php echo FB_LIVEUPLOADEDPATH ;?>/avatars/<?php echo $avatar;?>">
...
<?php
        ...
        echo '<form action="' . JB_LIVEURLREL . '&amp;func=uploadavatar&amp;do=validate' . '" method="post" name="adminForm" enctype="multipart/form-data">';
...
<?php
        ...
        echo "<br />\n";
        echo "<table width='100%' border='0' cellpadding='4' cellspacing='2'>";
        echo '<form action="' . JB_LIVEURLREL . '&amp;func=uploadavatar&amp;do=fromgallery'. '" method="post" name="adminForm">';
        ...
        for ($i = 0; $i < count($avatar_images); $i++)
        {
            ...
            echo '<img src="' . FB_LIVEUPLOADEDPATH . '/avatars/gallery/' . $gallery2 . $avatar_images[$i] . '">';
