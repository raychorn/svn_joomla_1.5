...
<table border = "0" cellspacing = "0" cellpadding = "0" width = "100%" align = "center">
            ...
            ?>
                ...
                else if ($do == "edit")
                {
                    ...
                    if ($allowEdit == 1)
                    {
                        ...
                        <form action = "<?php echo JB_LIVEURLREL."&catid=$catid&func=post"; ?>" method = "post" name = "postform" enctype = "multipart/form-data"/>
                ...
                else if ($do == "delete")
                {
                    ...
                    foreach ($message as $mes)
                    {
                        ...
                        <form action = "<?php echo JB_LIVEURLREL."&catid=$catid&func=post"; ?>" method = "post" name = "myform">
    ...
    <a href = "javascript:document.myform.submit();"><?php echo _GEN_CONTINUE; ?></a> | <a href = "<?php echo sefRelToAbs(JB_LIVEURLREL."&amp;func=view&catid=$catid;&amp;id=$id");?>"><?php echo _GEN_CANCEL; ?></a>
            ...
            ?>
                    ...
                    <form action = "<?php echo JB_LIVEURLREL."&func=post"; ?>" method = "post" name = "myform">
